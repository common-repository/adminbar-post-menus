...
class AdminbarPostMenus {
    ...
    protected $display_published = true,
    ...
    /**
     *
     * @param array $post_types - custom post types array(post_type_1,post_type_2)
     * @param init $items
     */
    public static function create_menu($post_types, $items = 5) {


        self::add_menus()
                ->set_post_types($post_types)
                ->set_list_count($items)
                ->nodes();
    }
